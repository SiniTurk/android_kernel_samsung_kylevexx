...
struct rt8973_data *pDrvData = NULL; /*driver data*/
struct platform_device *rtmus_dev = NULL; /* Device structure */
static struct rtmus_platform_data platform_data;
struct workqueue_struct *rtmus_work_queue = NULL;
/* self-own work queue */
#define ID_NONE 0
#define ID_USB  1
#define ID_UART 2
...
static int __init rt8973_init(void)
{
	...
	if (use_muic_rt8973 == 0) {
		...
		#if defined(CONFIG_MACH_HAWAII_SS_KYLEVE_REV00) || defined(CONFIG_MACH_HAWAII_SS_KYLEVESS_REV00) || defined(CONFIG_MACH_HAWAII_SS_JBTLP_REV00)
